...
INT2 VD_telamensagem(xi,yi,mens,cor,flag)
INT2     xi,yi;
char    *mens;
INT2     cor;
BOOLEAN flag;
...
VD_PUSHWIN(xi, xf+1, yi, yf+1);
 ...
 VIDEO_mensagem_default.col = xf - 3;
 VIDEO_mensagem_default.lin = yi + 2;
 ...
 switch(flag)
  {
   case 3:VIDEO_freq();
   case 0:VD_tprt_l((xf+xi+1)/2-3,yf-1,VIDEO_texto_ok,
