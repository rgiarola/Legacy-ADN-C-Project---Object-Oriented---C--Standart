...
#include <INCVIDEO.H>
char
     VIDEO_nome_central[]               = "CENTRAL.EXE"              ,
     VIDEO_nome_contas[]                = "CONTAS.EXE"               ;
...
VIDEO_valida_diretorio(campos,flagmens,param)
VIDEO_CAMPO_TELA  **campos;
BOOLEAN           flagmens;
VIDEO_NUCLEO_SERV **param;
{
 ...
 if (ret)
    {
     if (flagmens)
         VIDEO_mostra_mens_erro(VIDEO_VISUAL_caminho_invalido,TRUE);
     return(TRUE);
    }
