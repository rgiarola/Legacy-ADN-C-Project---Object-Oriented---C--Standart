/* ============================================================================
    CTREE_nxtrec()  - Dado o numero do arquivo ou indice, le o proximo
                      registro deste.
    NXTREC()        - Nome abreviado.
    PARAMETROS:     Numero do ctree arquivo ou indice,
                    modo_leitura de leitura de dados.
    RETORNA:        Zero se operacao ok, retorna isam_err em erro.
   ============================================================================ */
#include <INCVIDEO.H>

INT2 CTREE_nxtrec(numero_indice, modo_leitura)
INT2 numero_indice,
    modo_leitura;
{
 ...
 if ( (err=DATABASE_NextRecord( real_indice, buffer_leitura )) != 0 )
    return( I(err) );
