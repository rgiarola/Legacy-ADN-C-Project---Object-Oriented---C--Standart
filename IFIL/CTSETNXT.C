/* ============================================================================
    CTREE_setnxt()  - Le o proximo "set" de um registro apontado por uma chave.
...
INT2   CTREE_setnxt( numero_indice, modo_leitura)
INT2   numero_indice;
INT2   modo_leitura;
{
    ...
    if( (err=DATABASE_NextInSet( real_indice, buffer)) != FALSE )
        {
